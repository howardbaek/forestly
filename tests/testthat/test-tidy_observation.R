test_that("tidy_observation's 4 variables:'observation_from', 'observation_where', 'treatment_var' and 'treatment_order', must have input data.", {
  expect_error(tidy_observation(
    observation_where = NULL,
    treatment_var = "TRTA",
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
  ), "argument \"observation_from\" is missing")
  expect_error(tidy_observation(
    observation_from = adae,
    treatment_var = "TRTA",
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
  ), "argument \"observation_where\" is missing")
  expect_error(tidy_observation(
    observation_from = adae,
    observation_where = NULL,
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
...
test_that("tidy_observation can generate the table", {
  expect_s3_class(tidy_observation(
    observation_from = adae,
    observation_where = NULL,
    treatment_var = "TRTA",
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
...
test_that("tidy_observation can tidy the data", {
  ...
  #                  treatment_var    = "TRTA",
  #                  treatment_order  = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")).
  expect_equal(tidy_observation(
    observation_from = adae,
    observation_where = "SEX == 'M'",
    treatment_var = "TRTA",
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
  ), expectation_table(adae, "SEX == 'M'", "TRTA", c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")))
  ...
  expect_equal(tidy_observation(
    ...
    treatment_var = "TRTA",
    treatment_order = c("ABC" = "Xanomeline Low Dose")
  ), expectation_table(adae, TRUE, "TRTA", c("ABC" = "Xanomeline Low Dose")))
  ...
  expect_equal(tidy_observation(
    ...
    treatment_var = "TRTA",
    treatment_order = c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")
  ), expectation_table(adae, TRUE, "TRTA", c("MK9999" = "Xanomeline High Dose", "Placebo" = "Placebo")))
})
