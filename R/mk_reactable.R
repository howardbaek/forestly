...
#' The data table is an HTML widget that can be used in R Markdown documents and
#' Shiny applications, or viewed from an R console.
#'
#' @param data A data frame or matrix to obtain variables.such as 'iris' data
#'             set.
#' @param resizable A character string to define the criteria to enable columns
#'                  resizing.
#' @param filterable A character string to define the criteria to enable columns
#'                   filtering.
#' @param searchable A character string to define the criteria to enable global
#'                   table searching.
#' @param defaultPageSize A character string to define the Page size options for
#'                        the table.
